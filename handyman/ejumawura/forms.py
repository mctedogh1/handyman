...
class UpdateProfileMeta(forms.ModelForm):
    ...
    community = forms.CharField(max_length=250,help_text="community field is required.")

    class Meta:
        model = UserProfile
        fields = ('dob', 'contact', 'address', 'community')
...
class SaveCategory(forms.ModelForm):
    name = forms.CharField(max_length=50,help_text = "Category Name Field is required.")
...
class SavePost(forms.ModelForm):
    ...
    class Meta:
        model = Post
        fields = ('category', 'author','status','banner')
