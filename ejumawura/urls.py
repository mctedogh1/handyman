...
urlpatterns = [
    ...
    path('community/<int:community_id>/', views.community_handymen, name='community_handymen'),
    path('community/<int:community_id>/<str:category_name>/', views.category_posts, name='category_posts'),
    path('some-path/', views.choose_community, name='choose_community'),
